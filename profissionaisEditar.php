...
<?php
     if (isset($_GET['id_up']))//Se o usuario clicou no botão editar;
    {
        ...
        $cmd = $pdo->prepare("SELECT * FROM profissionais WHERE id = :id");
...
<body>
    <form method="post">
        ...
        <a id="btnVoltar" href="profissionais.php">Voltar</a>
    </form>
    <?php
    ...
    if (isset($_POST['Atualizar'])){
        ...
        $cmd = $pdo->prepare("UPDATE profissionais SET nome = :n, whatsapp = :w,  email = :e WHERE id = :id"); 
